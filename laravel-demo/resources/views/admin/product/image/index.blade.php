              ...
              <ul class="text-nowrap" id="images">
                ...
                <li class="float-left d-inline-block mr-2 mb-2" style="position: relative; width: 32%;">
                  <form action="./admin/product/{{ $product->id }}/image/{{ $productImage->id }}" method="post">
                    ...
                    <button type="submit" onclick="return confirm('Bạn có muốn xóa hình ảnh này?')" class="btn btn-sm btn-outline-danger border-0 position-absolute">
                      <i class="fas fa-times"></i>
                    </button>
                  </form>
                  <div style="width: 100%; height: 220px; overflow: hidden;">
                    <img style="height: 100%;" src="./front/img/products/{{ $productImage->path }}" alt="Image">
                  </div>
                </li>
                @endforeach
                ...
                <li class="float-left d-inline-block mr-2 mb-2" style="width: 32%;">
                  <form method="post" action="admin/product/{{ $product->id }}/image" enctype="multipart/form-data">
                    ...
                    <div style="height: 220px; overflow: hidden;">
                      <img style="width: 100%; height: 100%;object-fit: contain; cursor: pointer;" class="thumbnail" data-toggle="tooltip" title="Click to add image" data-placement="bottom" src="./dashboard/assets/images/add-image-icon.jpg" alt="Add Image">
