      ...
      <div class="main-card mb-3 card">
        <div class="card-body">
          ...
          <div class="position-relative row form-group">
            ...
            <div class="col-md-9 col-xl-8">
              <input required name="content" id="content" placeholder="Nội dung sản phẩm" type="text" class="form-control" value="{{ $product->content }}">
            </div>
          </div>
          ...
          <div class="position-relative row form-group">
            ...
            <div class="col-md-9 col-xl-8">
              <input required name="discount" id="discount" placeholder="Giá khuyến mãi" type="text" class="form-control" value="{{ $product->discount }}">
            </div>
          </div>
          ...
          <div class="position-relative row form-group">
            ...
            <div class="col-md-9 col-xl-8">
              <input required name="weight" id="weight" placeholder="Khối lượng sản phẩm" type="text" class="form-control" value="{{ $product->weight }}">
            </div>
          </div>
