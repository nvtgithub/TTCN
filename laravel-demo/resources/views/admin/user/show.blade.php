    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        ...
        <li class="nav-item delete">
            <form action="./admin/user/{{ $user->id }}" method="post">
                @csrf
                @method('DELETE')
                <button class="nav-link btn" type="submit" onclick="return confirm('Bạn có muốn xóa người dùng này?')">
                    <span class="btn-icon-wrapper pr-2 opacity-8">
                ...
                <div class="card-body display_data">
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-md-9 col-xl-8">
                            <p>
                                <img style="min-width: 50px; width: 100px;" class="rounded-circle" data-toggle="tooltip" title="Avatar" data-placement="bottom" src="front/img/users/{{ $user->avatar ?? 'default-avatar.png' }}" alt="Avatar">
                            </p>
                        </div>
                    </div>
