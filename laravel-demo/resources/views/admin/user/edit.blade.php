                    ...
                    <form method="post" action="/admin/user/{{ $user->id }}" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <img style="height: 200px; cursor: pointer;" class="thumbnail rounded-circle" data-toggle="tooltip" title="Click để chọn hình ảnh" data-placement="bottom" src="front/img/users/{{ $user->avatar == null ? 'default-avatar.png' : $user->avatar }}" alt="Avatar">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="password" id="password" placeholder="Nhập vào mật khẩu" type="password" class="form-control" value="">
                            </div>
                        </div>

                        <div class="position-relative row form-group">
                            <label for="password_confirmation" class="col-md-3 text-md-right col-form-label">Nhập lại mật khẩu</label>
                            <div class="col-md-9 col-xl-8">
                                <input name="password_confirmation" id="password_confirmation" placeholder="Nhập lại mật khẩu" type="password" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="company_name" id="company_name" placeholder="Nhập vào tên công ty" type="text" class="form-control" value="{{ $user->company_name }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="country" id="country" placeholder="Đất nước" type="text" class="form-control" value="{{ $user->country }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="street_address" id="street_address" placeholder="Nhập vào địa chỉ" type="text" class="form-control" value="{{ $user->street_address }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="postcode_zip" id="postcode_zip" placeholder="Nhập vào mã bưu điện" type="text" class="form-control" value="{{ $user->postcode_zip }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="town_city" id="town_city" placeholder="Tỉnh / Thành phố" type="text" class="form-control" value="{{ $user->town_city }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="phone" id="phone" placeholder="Số điện thoại" type="tel" class="form-control" value="{{ $user->phone }}">
                            </div>
                        </div>
