                ...
                <div class="card-body">
                    <form method="post" action="/admin/decoration/{{ $decoration->id }}" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <img style="cursor: pointer;" class="thumbnail" data-toggle="tooltip" title="Click để chọn hình ảnh" data-placement="bottom" src="front/img/{{ $decoration->image == null ? 'default-image.jpg' : $decoration->image }}" alt="Avatar">
