...
<div class="media">
     ...
     <div class="media-body">
         ...
         <p>
             ...
             @if (Auth::check())
                 <a href="" class="btn btn-sm btn-primary btn-show-reply-form" data-id="{{$comment->id}}">Trả lời</a>
             @else
         ...
         <form action="" method="POST" role="form" style="display:none" class="form-reply-{{$comment->id}}">
             <div class="form-group">
                 <label for="">Nội dung bình luận</label>
                 <input type="hidden" value="" name="">
                 <textarea name="comment" class="form-control" rows="3" required="required"
