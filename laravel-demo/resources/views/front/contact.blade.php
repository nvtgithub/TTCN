                ...
                <div class="col-lg-7 offset-lg-1">
                    ...
                    <div class="container">
                        ...
                        <div id="comment">
                            ...
                            {{-- @include('front.list-comment',['data' => $data]) --}}
                                ...
                                <div class="media-body">
                                    ...
                                    <form action="" method="POST" role="form" style="display:none"
                                        ...
                                        <button type="button" data-id="{{ $comment->id }}" class="btn btn-primary btn-send-comment-reply"
                                            onclick="sendCommentReply(this)">Gửi nội dung trả lời</button>
                                    </form>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <form action="" method="POST" role="form"
                                                        ...
                                                        <button type="submit" class="btn btn-primary">Gửi nội dung trả
                                                            lời</button>
                                                    </form>
                                                </div>
                                            </div>
