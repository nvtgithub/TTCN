...
<head>
    ...
    <title>Thông báo đặt hàng | Electronicstore</title>
</head>
                    ...
                    <tr>
                        ...
                        @if($order->payment_type == "pay_later")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      ...
                                      Bạn sẽ thanh toán khi nhận hàng. Chúng tôi vừa bàn giao đơn hàng của bạn cho một đối tác vận chuyển.
                                </span>
                            </td>
                        @endif
                        ...
                        @if($order->payment_type == "online_payment")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
                                      Đơn đặt hàng của bạn đã được thanh toán trực tuyến. Chúng tôi vừa bàn giao đơn hàng của bạn cho một đối tác vận chuyển.
                                </span>
                            </td>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        ...
                        <p>Nếu sản phẩm có dấu hiệu hư hỏng / hỏng hóc hoặc không khớp với thông tin trên
                            trang web, vui lòng liên hệ với cửa hàng trong vòng 48 giờ kể từ thời điểm nhận hàng cho
                            hỗ trợ.</p>
